<template>
  ...
  >
    <el-form
      ...
      label-width="125px"
    >
      <el-form-item label="追加金额" prop="addAwardAmount">
      ...
      <el-form-item label="追加次数" prop="addExpectNumbers">
      ...
      <el-form-item label="红包金额比" prop="addEnvelopeProportion">
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" @click="saveAdd('appendForm')">确 定</el-button>
    </span>
  </el-dialog>
</template>
<script>
