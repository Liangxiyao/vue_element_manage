  ...
  <div class="prize">
    <el-table :data="tableData"
      ...
      <el-table-column prop="totalAverage"
                       label="预计获得平均金额"></el-table-column>
      <el-table-column prop="weakenLine"
                       label="衰减阶段"></el-table-column>
      ...
      <el-form ref="form">
        ...
        <el-form-item class="newDate"
          ...
          <el-date-picker v-model="newDate"
                          ...
                          :picker-options="appendTimePickerOptions"></el-date-picker>
        </el-form-item>
      </el-form>
      <span slot="footer"
            class="dialog-footer">
      ...
      <el-form ref="exportForm"
        ...
        <el-form-item prop="exportDate"
          ...
          <el-date-picker v-model="exportForm.exportDate"
                          ...
                          :picker-options="exportPickerOptions"></el-date-picker>
        </el-form-item>
      </el-form>
      <span slot="footer"
            class="dialog-footer">
  ...
  methods: {
    ...
    saveExport(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          let { exportDate } = this.exportForm
          apiExportRecord({
            awardId: this.currentRow.id,
            beginDate: getDate(exportDate[0],1),
            endDate: getDate(exportDate[1],1),
          }).then((result) => {
