  ...
  <div class="setExtraAward">
    <el-form :model="formData"
      ...
      <template v-if="formData.awardType == '1'">
        <el-form-item label="活力金额"
                      prop="vigourAmount">
          <el-input v-model="formData.vigourAmount"
                    placeholder="请输入红包金额"></el-input>
        </el-form-item>
        <el-form-item label="达星金额"
                      prop="awardAmount">
      ...
      <template v-else>
        <el-form-item label="活力奖品名称"
                      prop="vigourName">
          <el-input v-model="formData.vigourName"
                    placeholder="请输入奖品名称"></el-input>
        </el-form-item>
        <el-form-item label="达星奖品名称"
                      prop="awardName">
